function drawChart(chartData) {
  ...
  console.log(document.getElementById('piechart_' + chartData.title.toLowerCase()).parentNode.parentNode.className);
  if(document.getElementById('piechart_' + chartData.title.toLowerCase()).parentNode.parentNode.className === "panel-body"){
    options.width = 400;
  }
